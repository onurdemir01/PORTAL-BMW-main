...
portal reposunda **yalnızca referans** olarak durur (`server/ansible/bmw_portal/logx/{legacy,ocp}/logx_*.yml`);
...
```bash
ansible-playbook --syntax-check server/ansible/bmw_portal/logx/ocp/logx_ocp_app_discovery.yml
```
