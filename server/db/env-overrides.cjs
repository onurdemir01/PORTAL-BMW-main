...
const SYSTEM_CONFIG_KEYS = [
  ...
  'SMART_CREATE_TICKET_PATH', 'SMART_GET_METADATA_PATH', 'SMART_CHECK_TICKET_PATH', 'SMART_SERVICEREPOSITORY_URL',
  'SMART_POLL_INTERVAL_SECONDS', 'SMART_TICKET_TIMEOUT_HOURS', 'SMART_PROXY_URL',
