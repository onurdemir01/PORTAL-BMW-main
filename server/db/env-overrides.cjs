...
const SYSTEM_CONFIG_KEYS = [
  ...
  'SMART_API_URL', 'SMART_API_USERNAME', 'SMART_API_PASSWORD', 'SMART_RFF_TOKEN',
  'SMART_CREATE_TICKET_PATH', 'SMART_CHECK_TICKET_PATH',
  'SMART_POLL_INTERVAL_SECONDS', 'SMART_TICKET_TIMEOUT_HOURS',
];
