...
const ENV_VARS: EnvVarMeta[] = [
  ...
  { key: "SMART_API_URL", label: "Smart API URL", group: "Smart", description: "Kurum içi talep yönetim sistemi (Smart/RFF) REST API taban adresi.", required: false, example: "https://smart-api.garanti.com.tr", usedIn: "server/smart/client.cjs", restartRequired: false },
  { key: "SMART_API_USERNAME", label: "Smart Kullanıcı Adı", group: "Smart", description: "Smart API'ye Basic Auth ile bağlanan servis hesabı.", required: false, example: "svc-portal-smart", usedIn: "server/smart/client.cjs", restartRequired: false },
  ...
  { key: "SMART_RFF_TOKEN", label: "RFF Request Token", group: "Smart", description: "Talep açma/durum sorgusu isteklerine eklenen özel header değeri — DB'de şifreli saklanır.", required: false, example: "••••••••", usedIn: "server/smart/client.cjs", restartRequired: false },
  { key: "SMART_CREATE_TICKET_PATH", label: "Talep Açma Path'i", group: "Smart", description: "Smart API taban adresine eklenen, yeni talep açma endpoint yolu.", required: false, example: "/rff/create", usedIn: "server/smart/client.cjs", restartRequired: false },
  { key: "SMART_CHECK_TICKET_PATH", label: "Durum Sorgulama Path'i", group: "Smart", description: "Smart API taban adresine eklenen, talep durumu sorgulama endpoint yolu.", required: false, example: "/rff/status", usedIn: "server/smart/client.cjs", restartRequired: false },
