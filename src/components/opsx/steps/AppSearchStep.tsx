// src/components/opsx/steps/AppSearchStep.tsx — uygulama seçimi. LogX'in
// AppSearchStep'iyle BİREBİR aynı davranış (kullanıcı isteği): aranabilir liste,
// DB erişilemezse snapshot fallback uyarısı.
