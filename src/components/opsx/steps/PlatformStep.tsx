// src/components/opsx/steps/PlatformStep.tsx — OpsX'in ilk adımı. Yapı ve stil
// LogX'in PlatformStep'iyle BİREBİR aynı (kullanıcı isteği); yalnızca metinler
// operasyon bağlamına göre değişir.
import React from "react";
import { ServerStackIcon, CubeTransparentIcon } from "@heroicons/react/24/outline";
import type { OpsxPlatform } from "@/api/opsxApi";

const PlatformStep: React.FC<{ onSelect: (p: OpsxPlatform) => void; busy?: boolean }> = ({ onSelect, busy }) => (
  <div className="py-6">
    <p className="text-sm text-[var(--text-secondary)] text-center mb-6">
      Hangi tipteki uygulamanız için işlem yapmak istiyorsunuz?
    </p>
