...
const SpaPlanPage = lazyWithRetry(() => import('@/components/spa_plan/SpaPlanPage'));
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route element={<PageVisibilityRoute pageId="SpaPlan" />}>
              <Route path="/tasima-plani" element={<SpaPlanPage />} />
            </Route>
